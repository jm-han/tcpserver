...
#include <memory>
#include "../tcpserver/camerathread.h"
...
QT_MOC_LITERAL(3, 23, 8), // "sockDesc"
QT_MOC_LITERAL(4, 32, 4) // "data"

    },
    "camerathread\0sendData\0\0sockDesc\0data"
};
...
void camerathread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (camerathread::*)(int , const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&camerathread::sendData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void camerathread::sendData(int _t1, const QByteArray & _t2)
{
